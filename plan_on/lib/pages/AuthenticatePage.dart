...
import '../custom/Auth_Service.dart';
...
class _AuthenticatePageState extends State<AuthenticatePage> {
  ...
  Widget build(BuildContext context) {
    ...
    user_ph_no = SharedPref.getString("user_ph_no");
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () {
                  phNum = phoneController.text;
                  // SharedPref.getInstance();
                  SharedPref.putString("user_ph_no", phNum);
                  SharedPref.putString("logged_out", "0");
                  SharedPref.putString("logged_in_flag", "1");
                  //Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder) => HomePage()), (route) => false);
